...
var playState1v1 = {
    ...
    create: function()
    {
        ...
        {
            case 1:
                map = game.add.tilemap('map1sprite');
                ...
                break;
            case 2:
                map = game.add.tilemap('map2sprite');
                ...
                break;
            case 3:
                map = game.add.tilemap('map3sprite');
                ...
                break;
            case 4:
                map = game.add.tilemap('map4sprite');
                ...
                break;
            case 5:
                map = game.add.tilemap('map5sprite');
